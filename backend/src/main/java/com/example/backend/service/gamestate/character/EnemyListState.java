...
public class EnemyListState {
    ...
    public EnemyListState() {
        this.enemyList.add(new EnemyState("スライム", 1, 70, 70, 5, 5, 5, 20, 50, "/img/enemy/スライム.png"));
        this.enemyList.add(new EnemyState("ゴブリン", 1, 90, 90, 8, 5, 8, 50, 80, "/img/enemy/ゴブリン.png"));
    }
